...
class Widget
{
    ...
    public function __construct()
    {
        ...
        $this->data=[];
        $this->trigger=[];
        $this->file_upload_url=url('admin/Ueditor/upload',array('action'=>'uploadfile'));
        $this->img_upload_url=url('admin/Ueditor/upload',array('action'=>'uploadimage'));
        ...
        foreach ($groups as $k=>$v){
            if(isset($v['dropdown']) && $v['dropdown']){
                ...
                foreach ($v['dropdown'] as $kk=>$dropdown){
                    ...
                    if(isset($dropdown['is_active']) && $dropdown['is_active']) $has_active_dropdown=true;
                }
            ...
            if(isset($v['is_active']) && $v['is_active']) $has_active=true;
        }
