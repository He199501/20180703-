...
class IconForm
{
     ...
     * @return string
     */
    public function fetch($name,$title,$default='0',$help_text='',$attr=[],$extra_class='col-xs-10 col-sm-5',$extra_attr='')
    {
        $data=[
            'name' => $name,//name
            'title' => $title,//标签
        ...
        $html .='<span class="input-group-addon icon" data-rel="tooltip" data-placement="bottom" data-original-title="点击选择图标"><i class="fa fa-info-circle"></i></span>';
