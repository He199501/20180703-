                ...
                foreach ($right_actions as $key=>$value){
                    switch ($key){
                        case 'edit':
                            $html .='<li>';
                            if(is_string($value) || !isset($value['is_pop']) ||empty($value['is_pop'])){
                                $html .='<a href="'.$value.'" data-id="'.$data[$pk].'" class="tooltip-success yf-modal-open" data-rel="tooltip" title="" data-original-title="修改"><span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i></span></a>';
                            }else{
                                $html .='<a href="javascript:;" data-title="修改" data-url="'.(isset($value['href'])?$value['href']:'').'" data-id="'.$data[$pk].'" class="tooltip-success edit-btn" data-rel="tooltip" title="" data-original-title="修改"><span class="green"><i class="ace-icon fa fa-pencil-square-o bigger-120"></i></span></a>';
                            }
                            $html .='</li>';
                            break;
                        case 'delete':
